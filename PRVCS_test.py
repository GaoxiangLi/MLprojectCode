...
np.savetxt("./training_feature5.csv", training_feature, delimiter=",")
np.savetxt("./training_label5.csv", training_label, delimiter=",")
np.savetxt("./test_feature5.csv", test_feature, delimiter=",")
np.savetxt("./test_label5.csv", test_label, delimiter=",")
print("done")
